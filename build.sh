...
${nuget_cmd} install src/TmApi/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/TmApi.dll"
...
then
  ...
  echo "[INFO] bin/TmApi.dll was created successfully"
fi
